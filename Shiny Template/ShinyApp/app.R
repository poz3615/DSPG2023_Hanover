                 ...
                 tabPanel("Meet the Team", 
                          ...
                          fluidRow(style = "margin-left: 100px; margin-right: 100px;",
                                   column(6, align = "center",
                                          ...
                                          p(a('Ari Tynes', target = '_blank'), "(Berea College, Undergraduate in Economics);",
                                            br(), 
                                            a(href = 'https://www.linkedin.com/in/john-malla-4b03b0232/', 'Deep Datta', target = '_blank'), "(Virginia Tech, Undergraduate in Computational Modeling and Data Analytics and Computer Science);",
                                            br(), 
                                            a(href = 'https://www.linkedin.com/in/christophercvest', 'Gabe Wiggins', target = '_blank'), "(Virginia Tech, Undergraduate in Environmental Economics)."),
                                          p("", style = "padding-top:10px;"),
